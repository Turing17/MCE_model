...
if __name__ == '__main__':
    path_log = 'log/{}_{}_{}'.format(get_time_code(),'6','2020')
    ...
    for epoch in range(epochs):
        ...
        for step, data in enumerate(train_loader, start=0):
            ...
            loss = loss_function(logits, p_labels.to(device))
        ...
        with torch.no_grad():
            for index_val, val_data in enumerate(val_loader):
                ...
                # 计算验证loss
                val_loss = loss_function(outputs, val_p_labels.to(device))
